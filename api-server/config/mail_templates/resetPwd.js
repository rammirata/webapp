module.exports.generateMail = (resetLink, name) => ({
	subject: "Reset Your Blockway Password",
	body: body
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; mso-line-height-alt: 16.8px; color: #506bec; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><strong><span style="font-size:38px;">
																			Reset Your Password on Blockway
																		</span></strong></p>
																	</div>
																</div>
															</td>
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span style="font-size:16px;">
																			Hey $NAME, it looks like you need to reset your password for your Blockway account. Don't worry, this is a quick and easy process!
																		</span></p>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
																		<p style="margin: 0; font-size: 14px;"><span style="font-size:16px;">
																			Simply click the button below to reset your password and get back to using your app.blockway.tech account.
																		</span></p>
																	</div>
																</div>
															</td>
																...
																<div style="font-family: sans-serif">
																	<div class="txtTinyMce-wrapper" style="font-size: 14px; mso-line-height-alt: 16.8px; color: #97a2da; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
																		<p style="margin: 0; font-size: 14px; text-align: center;">
																			...
																			<br>
																			Please feel free to contact us at bussiness@blockway.tech.
																		</p>
																	</div>
																</div>
															</td>
